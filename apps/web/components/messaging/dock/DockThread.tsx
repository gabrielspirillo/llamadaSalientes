    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      <div className="flex shrink-0 items-center gap-2 border-t border-white/60 bg-white/70 px-3 py-2.5">
        ...
        <button
          ...
          aria-label="Enviar"
          className="sheen press inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[linear-gradient(120deg,#37766a,#5fa896)] text-white shadow-[0_8px_20px_-10px_rgba(113,57,232,0.9)] transition-all disabled:pointer-events-none disabled:opacity-40"
        >
