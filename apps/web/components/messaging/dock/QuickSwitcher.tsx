                ...
                <li key={`${r.type}-${r.id}`}>
                  ...
                  >
                    ...
                    {r.type === 'channel' && r.unread > 0 && (
                      <span className="inline-flex min-w-[20px] shrink-0 items-center justify-center rounded-full bg-violet-600 px-1.5 py-0.5 text-[10px] font-semibold tabular-nums text-white">
