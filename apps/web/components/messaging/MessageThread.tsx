    ...
    >
      ...
      {showJump && (
        <button
          ...
          className="press absolute bottom-28 left-1/2 z-20 inline-flex -translate-x-1/2 animate-fade-up items-center gap-1.5 rounded-full bg-[linear-gradient(120deg,#37766a,#5fa896)] px-3.5 py-1.5 text-[12px] font-semibold text-white shadow-[0_10px_30px_-8px_rgba(113,57,232,0.75)]"
        >
          Nuevos mensajes
