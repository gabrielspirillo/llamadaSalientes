        ...
        <div className="flex items-center gap-1 px-4 sm:px-6 border-b border-[--color-border-subtle] overflow-x-auto">
          ...
          <TabButton active={tab === 'llamadas'} onClick={() => setTab('llamadas')}>
            ...
            {data && data.calls.length > 0 && (
              <span className="text-[11px] font-semibold bg-zinc-100 text-zinc-700 rounded-full px-1.5 py-0.5">
                {data.calls.length}
              </span>
            )}
          </TabButton>
          <TabButton active={tab === 'citas'} onClick={() => setTab('citas')}>
            ...
            {upcomingCount > 0 && (
              <span className="text-[11px] font-semibold bg-emerald-100 text-emerald-700 rounded-full px-1.5 py-0.5">
                {upcomingCount}
              </span>
            )}
          </TabButton>
