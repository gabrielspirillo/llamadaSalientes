    ...
    <>
      ...
      <div className="space-y-0.5 px-3 pb-4">
        ...
        <button
          ...
          className="group flex w-full items-center gap-3 rounded-2xl px-2.5 py-2 text-[13.5px] font-medium text-zinc-600 transition-all duration-300 hover:bg-white/70 hover:text-zinc-900"
        >
