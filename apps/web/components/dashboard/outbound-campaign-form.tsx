    ...
    <form onSubmit={onSubmit} className="space-y-5">
      ...
      <Card className="p-4 sm:p-6 space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <label className="inline-flex h-10 cursor-pointer items-center gap-2 rounded-[22px] border border-[--color-border] bg-white shadow-[var(--shadow-soft)] px-3.5 text-sm hover:bg-brand-50/50">
