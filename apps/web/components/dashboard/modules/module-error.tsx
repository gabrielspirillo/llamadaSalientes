  ...
  return (
    <Card className="animate-fade-up">
      <div className="p-8 text-center">
        ...
        <p className="text-[17px] font-semibold text-zinc-800">
          No se pudieron cargar las métricas{label ? ` de ${label}` : ''}
        </p>
        <p className="mt-1 text-[16px] text-zinc-500">Reintentá en unos segundos.</p>
        {detail && (
          <code className="mt-4 inline-block max-w-full break-all rounded-xl bg-rose-50 px-3 py-2 text-left text-[13px] text-rose-700 ring-1 ring-inset ring-rose-100">
            {detail}
          </code>
        )}
      </div>
