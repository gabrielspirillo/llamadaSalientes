  ...
  return (
    <Card className="animate-fade-up">
      <div className="p-8 text-center">
        ...
        <p className="mt-1 text-[13px] text-zinc-500">Reintentá en unos segundos.</p>
        {detail && (
          <code className="mt-4 inline-block max-w-full break-all rounded-xl bg-rose-50 px-3 py-2 text-left text-[11px] text-rose-700 ring-1 ring-inset ring-rose-100">
            {detail}
          </code>
        )}
      </div>
