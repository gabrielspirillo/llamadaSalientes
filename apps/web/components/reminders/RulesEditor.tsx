        ...
        <div className="flex flex-wrap gap-1.5">
          {REMINDER_VARIABLES.map((v) => (
            <button
              ...
              title={v.description}
              className="rounded-md border border-[--color-border] bg-white px-2 py-1 font-mono text-[12px] text-zinc-700 hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-700 transition-colors"
            >
              {v.token}
            </button>
          ))}
