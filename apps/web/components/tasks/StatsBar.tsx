            ...
            {stats.perMember
              ...
              .map(({ pm, member }) => (
                ...
                >
                  ...
                  <span className="text-[12px] tabular-nums text-zinc-500">{pm.open} abiertas</span>
                  {pm.overdue > 0 && (
                    <span className="rounded-full bg-red-50 px-1.5 text-[11px] font-semibold tabular-nums text-red-600">
                      {pm.overdue} vencidas
                    </span>
                  )}
                  {pm.doneThisWeek > 0 && (
                    <span className="rounded-full bg-emerald-50 px-1.5 text-[11px] font-semibold tabular-nums text-emerald-700">
                      {pm.doneThisWeek} ✓
                    </span>
                  )}
                </li>
