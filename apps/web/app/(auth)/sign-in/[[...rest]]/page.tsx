  ...
  return (
    <div className="grid min-h-screen bg-white lg:grid-cols-2">
      ...
      <AuthAside eyebrow="Caso real">
        ...
        <blockquote className="text-[31px] font-bold leading-snug tracking-tight">
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <div>
            <p className="text-[17px] font-bold">Dra. Patricia Mendoza</p>
            <p className="text-[16px] text-white/60">Directora · Sonrisa Clínica Estética</p>
          </div>
        </div>
        ...
        <dl className="mt-10 grid grid-cols-3 gap-3">
          {[
            ...
            >
              <dt className="text-[24px] font-extrabold leading-none tracking-tight">{s.k}</dt>
              <dd className="mt-1.5 text-[13px] leading-tight text-white/60">{s.v}</dd>
            </div>
          ))}
        </dl>
      </AuthAside>
