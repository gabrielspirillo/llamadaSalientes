            ...
            {appointments.map((a) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {a.status && (
                    <span
                      className={`rounded-full px-2 py-0.5 text-[11px] font-semibold uppercase ${appointmentStatusClass(a.status)}`}
                    >
                      {a.status}
                    </span>
                  )}
      ...
      {notes.length === 0 ? (
        ...
        <ul className="space-y-2">
          {notes.map((n) => (
            ...
            >
              <div className="flex items-center justify-between text-[11px] uppercase text-amber-700">
