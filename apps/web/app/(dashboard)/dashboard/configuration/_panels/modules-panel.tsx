...
export async function ModulesPanel() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-[20px] font-bold tracking-tight text-zinc-900">Módulos por tenant</h2>
      ...
      <div className="overflow-x-auto rounded-[22px] border border-[--color-border] bg-white shadow-[var(--shadow-soft)]">
        <table className="w-full text-sm">
          <thead className="border-b border-[--color-border] bg-[#fafbfb] text-left text-[11px] font-bold uppercase tracking-[0.14em] text-zinc-400">
            <tr>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex flex-col">
                      <span className="font-medium text-zinc-900">
                        {row.name}
                        {isDemo && (
                          <span className="ml-2 inline-flex items-center rounded-full bg-emerald-50 px-2 py-0.5 text-[12px] font-medium text-emerald-700">
                            demo
                          </span>
                        )}
                      </span>
