      ...
      <Card>
        <div className="divide-y divide-[--color-border-subtle]">
              ...
              >
                <div className="flex min-w-0 items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <p className="truncate text-[15px] font-bold text-zinc-900">{userName}</p>
          ...
          {invitations.data.map((inv) => (
            ...
            >
              <div className="flex min-w-0 items-center gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-zinc-100 text-[14px] font-bold text-zinc-400 ring-2 ring-white">
                  {initials(inv.emailAddress)}
                </div>
                <div className="min-w-0">
                  <p className="truncate text-[15px] font-bold text-zinc-900">{inv.emailAddress}</p>
