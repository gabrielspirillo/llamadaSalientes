      ...
      <div className="p-4 sm:p-6">
        ...
        >
          ...
          <p className="text-xs text-zinc-500 mt-3">
            ...
            {locationId && (
              <>
                {' '}
                Tu Location ID es <code className="text-[12px]">{locationId}</code>.
              </>
            )}
          </p>
        </Section>
        ...
        >
          ...
          <details className="mt-4 group">
            ...
            <pre className="mt-2 rounded-xl bg-[#14211d] text-zinc-100 text-[12px] p-3 overflow-x-auto leading-relaxed">{`curl -X POST '${intakeUrl}' \\
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-3">
        <span className="h-5 w-5 rounded-full bg-zinc-900 text-white text-[12px] font-semibold inline-flex items-center justify-center">
          {number}
        </span>
        <div>
