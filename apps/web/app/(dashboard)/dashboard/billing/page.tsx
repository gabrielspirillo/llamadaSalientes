            ...
            <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="rounded-full bg-white/10 px-3 py-1 text-[12px] font-semibold text-white/90 ring-1 ring-inset ring-white/15">
                    Plan actual
                  </span>
                  <span className="inline-flex items-center gap-1 rounded-full bg-emerald-400/15 px-3 py-1 text-[12px] font-semibold text-emerald-300">
                    <CheckCircle2 className="h-3 w-3" /> Activo
                  </span>
                </div>
                <h3 className="mt-4 text-[37px] font-extrabold leading-none tracking-tight">Pro</h3>
          ...
          <Card className="h-full">
            ...
            <div className="px-5 pb-5 sm:px-6 sm:pb-6">
              <div className="flex items-center gap-3 rounded-2xl border border-[--color-border] bg-[#fafbfb] p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[var(--shadow-soft)]">
                ...
                <div>
                  <p className="text-[15px] font-bold tabular-nums text-zinc-900">•••• 4242</p>
                  <p className="text-[13px] text-zinc-500">Expira 09/27</p>
                </div>
              </div>
      ...
      <Card>
        ...
        <div className="border-t border-[--color-border-subtle] divide-y divide-[--color-border-subtle]">
          {invoices.map((i) => (
            ...
            >
              <div className="min-w-0">
                <p className="truncate font-mono text-[14px] font-bold text-zinc-900">{i.id}</p>
                <p className="mt-0.5 text-[13px] text-zinc-500">{i.date}</p>
              </div>
              <div className="flex shrink-0 items-center gap-2 sm:gap-4">
                <span className="text-[14px] font-bold tabular-nums text-zinc-800">{i.amount}</span>
